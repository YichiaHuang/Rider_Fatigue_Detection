...
SCORE_THRESH = 0.75  # was 0.9 - real detector confidence on our footage clusters ~0.85-0.93,
                      # so 0.9 was missing ~94% of frames; 0.75 gets 99% detection on
                      # yawn_eye_test.avi with margin above the lowest observed score (0.755)
MAX_FACE_NUM = 1
ANCHOR_STRIDES = [8, 16]
ANCHOR_NUM = [2, 6]
